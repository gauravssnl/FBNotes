...
posts = graph.get_object(
    "me/feed?since=10 February 2017 & until=11 February 2017")
# print(posts)
# print("-"*70)
...
comments_data = graph.get_object(
    note_postid + "?fields=comments.summary(true)")
print(comments_data)
print("-" * 70)
...
comments_data = graph.get_object(
    note_postid + "/comments?limit=" + str(comments_count))
# print(comments_data)
# print("-"*70)
